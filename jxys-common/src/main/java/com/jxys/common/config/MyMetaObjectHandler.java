package com.jxys.common.config;
...
public class MyMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        //存入userId
        this.setFieldValByName("createBy", SecurityUtils.getLoginUser().getUserId(), metaObject);
    }
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        //存入userId
        this.setFieldValByName("updateBy", SecurityUtils.getLoginUser().getUserId(), metaObject);
    }
